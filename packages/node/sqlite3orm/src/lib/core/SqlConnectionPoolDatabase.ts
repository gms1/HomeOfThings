...
export class SqlConnectionPoolDatabase extends SqlDatabase {
  ...
  @internal
  */
  public openByPool(pool: SqlConnectionPool, databaseFile: string, mode?: number, settings?: SqlDatabaseSettings): Promise<void> {
  ...
  */
  ...
  @internal
  */
  public async recycleByPool(pool: SqlConnectionPool, sqldb: SqlConnectionPoolDatabase, settings?: SqlDatabaseSettings): Promise<void> {
    /* istanbul ignore else */
    if (sqldb.db) {
      try {
