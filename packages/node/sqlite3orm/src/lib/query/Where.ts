...
export function getPropertyComparison<MT, K extends keyof MT>(propertyPredicate: PropertyPredicates<MT[K]>, key: string): any {
...
export function isModelPredicates<MT>(cond?: Condition<MT>): cond is ModelPredicates<MT> {
  return cond && (cond as any).not === undefined && (cond as any).or === undefined && (cond as any).and === undefined && (cond as any).sql === undefined ? true : false;
}
