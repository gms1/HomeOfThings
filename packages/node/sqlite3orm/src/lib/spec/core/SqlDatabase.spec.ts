...
describe('test SqlDatabase', () => {
  ...
  it('expect basic dmls to succeed', async () => {
    try {
      ...
      const row = await sqldb.get('SELECT col FROM TEST WHERE id=:id', {
        ':id': 1,
      });
    ...
    try {
      ...
      const count = await sqldb.each('SELECT id, col FROM TEST WHERE id >= ? order by id', [0], (err, row) => {
        if (err) {
  ...
  it('expect closed database to throw on exec', async () => {
    try {
      ...
      failTest('closed database should throw on exec');
    } catch (err) {}
  });
  // ---------------------------------------------
  it('expect closed database to throw on prepare', async () => {
    try {
      ...
      failTest('closed database should throw on prepare');
    } catch (err) {}
  });
  // ---------------------------------------------
  it('expect closed database to throw on run', async () => {
    try {
      ...
      failTest('closed database should throw on run');
    } catch (err) {}
  });
  // ---------------------------------------------
  it('expect closed database to throw on get', async () => {
    try {
      ...
      failTest('closed database should throw on get');
    } catch (err) {}
  });
  // ---------------------------------------------
  it('expect closed database to throw on all', async () => {
    try {
      ...
      failTest('closed database should throw on all');
    } catch (err) {}
  });
  // ---------------------------------------------
  it('expect closed database to throw on each', async () => {
    try {
      ...
      failTest('closed database should throw on each');
    } catch (err) {}
  });
  ...
  it('expect closed database to throw on adding event listener', async () => {
    try {
      await sqldb.close();
      sqldb.on('error', () => {});
      failTest('closed database should throw on adding event listener');
    } catch (err) {}
  });
  // ---------------------------------------------
  ...
  it('expect insert into not existing table to throw', async () => {
    try {
      ...
      failTest('insert into not existing table should throw');
    } catch (err) {}
  });
  ...
  it('expect get from not existing table to throw', async () => {
    try {
      ...
      failTest('get from not existing table should throw');
    } catch (err) {}
  });
  ...
  it('expect prepare from not existing table to throw', async () => {
    try {
      ...
      failTest('prepare from not existing table should throw');
    } catch (err) {}
  });
...
describe('test SqlDatabase when sqlcipher IS available', () => {
  ...
  it('should be able to read encrypted content', async () => {
    if (!sqlcipherVersion) {
      console.warn('sqlcipher IS NOT available');
      return;
    }
    try {
      const res = await sqldb.all('SELECT id, col FROM TEST order by id');
...
describe('test SqlDatabase when sqlcipher IS NOT available', () => {
  ...
  it('', async () => {
    ...
    try {
      ...
      failTest('should not be able to read the database content');
    } catch (err) {
      return;
    }
  });
